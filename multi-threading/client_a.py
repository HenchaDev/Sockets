...
server_host = ''  # An empty string means the client will connect to the server on the same machine
server_port = 45549  # The same port number as used in the server

# Function to start client A
def start_client_a():
...
if __name__ == "__main__":
    start_client_a()  # Start client A when the script is executed
